...
namespace HeuristicLab.Problems.AutomaticSoftwareRepair.Encodings.General {
  ...
  [StorableClass]
  public abstract class SolutionProgramEncoding : Item, IASREncoding {
    ...
    public SolutionProgramEncoding(IASRProblemInstance problemInstance) {
      SolutionPrograms = new ItemList<SolutionProgram>();

      ProblemInstance = problemInstance;
    }

    [StorableConstructor]
    protected SolutionProgramEncoding(bool serializing)
        : base(serializing) {
    }

    protected SolutionProgramEncoding(SolutionProgramEncoding original, Cloner cloner)
        : base(original, cloner) {
      this.SolutionPrograms = (ItemList<SolutionProgram>)cloner.Clone(original.SolutionPrograms);
